  ...
  return (
    <div>
      ...
      <div className="text-center relative mb-8">
        <span className="text-[75px] font-extrabold tracking-tighter text-transparent bg-clip-text bg-gradient-to-t from-25% from-transparent to-ash-300 flex justify-center absolute -top-[65px] inset-x-0 md:text-[125px] md:-top-[110px]">logicLot</span>
      ...
      <div className="grid gap-4 mt-10 md:grid-cols-2 lg:grid-cols-3">
        {items.map((item, index) => {
          ...
          return (
            <div
              key={index}
              className="bg-white relative border border-ash-300 shadow-2xl shadow-ash-200 rounded-3xl group overflow-hidden p-6 z-10 md:p-8"
            >
              <Icon className="size-60 text-ash-100 absolute -top-20 -right-20 stroke-[0.25] -rotate-45 transition-[color] -z-10 group-hover:text-ash-200" />
