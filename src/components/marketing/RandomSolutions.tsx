    ...
    <section className="pt-14 md:pt-28">
              ...
              >
                ...
                <div className="flex items-center justify-between gap-2 py-2.5 px-6">
                  <div className="flex items-center justify-between gap-4">
                    <span className="text-sm text-ash-800 font-semibold">
      ...
      <div className="max-w-4xl bg-ash-900 flex flex-col p-6 items-center justify-between gap-6 mt-10 mx-4 rounded-3xl md:flex-row md:p-8 lg:mx-auto">
        ...
        >
          ...
          <svg className="size-4 text-ash-800" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M7 7h10v10"/><path d="M7 17 17 7"/></svg>
        </Link>
      </div>
    </section>
  );
